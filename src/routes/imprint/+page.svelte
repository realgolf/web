...
<p>
  ...
  according to Section 7, Paragraph 1 of the German Telemedia Act (TMG).
  According to §§ 8 to 10 TMG, however, we as a service provider are not obliged
...
<p>
  ...
  from the point in time at which knowledge of a specific infringement of the
  law is known. As soon as we become aware of any violations of the law, we will
...
<p>
  ...
  Therefore we cannot assume any liability for this external content. The
...
<p>
  ...
  reasonable without concrete evidence of an infringement. As soon as we become
...
<p>
  ...
  to German copyright law. The duplication, editing, distribution and any kind
...
<p>
  ...
  copyrights of third parties are observed. In particular contents of third
  parties are marked as such. Should you nevertheless become aware of a
  copyright infringement, we ask that you inform us accordingly. As soon as we
