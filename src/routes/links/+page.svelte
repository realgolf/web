<script lang="ts">
	...
	import Button from '$lib/components/Url-Shortner/Button.svelte';
	import Loader from '$lib/components/Url-Shortner/Loader.svelte';
	import TextInput from '$lib/components/Url-Shortner/TextInput.svelte';
...
<div class="text-light">
	Yet another tool to create short URLs. Notice that this is a hobby project. We do not guarantee
	that the links will be stored forever.
</div>
...
>
	<div>
		<TextInput label="URL" name="url" value={form?.url ?? ''} disabled={loading} />
	</div>
	<div>
