...
<main>
  ...
  <p class="success">
    Everything about the Rules is in the Card labeld <b>Rules</b>.
  </p>
  <p class="success">
    If the normal games are to boring, you can find more challenging ideas in
    the Card labeled <b>Levels</b>.
  </p>
